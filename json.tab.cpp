...
{
  "$end", "error", "$undefined", "TT_LEFT_BRACE", "TT_RIGHT_BRACE",
  "TT_LEFT_BRACKET", "TT_RIGHT_BRACKET", "TT_COMMA", "TT_COLON", "TT_INT",
  "TT_DOUBLE", "TT_STRING", "TT_ERROR", "$accept", "json_object",
  "json_array", "json_array_elem", "json_array_object", "json_dict",
  "json_dict_elem", "json_dict_object", YY_NULLPTR
};
#endif
...
{
      15,     1,    -3,     4,    -8,    -8,    -8,    -7,     9,     3,
      -8,    -8,    -8,    -8,    -8,     8,    12,    -8,     6,    -8,
      10,    -8,     6,    -8,    -8,    -8
};
...
{
       0,     0,     0,     0,     2,     3,    13,     0,     0,    14,
       5,    10,     9,     8,    11,     0,     6,     1,     0,    12,
       0,     4,     0,    16,    15,     7
};
...
{
       1,    18,     2,    10,    17,     6,    11,    12,    13,     1,
      20,     2,     7,    19,    21,    11,    12,    13,     1,    22,
       2,     7,     3,    23,    25,     0,     0,    24
};

static const yytype_int8 yycheck[] =
{
       3,     8,     5,     6,     0,     4,     9,    10,    11,     3,
       7,     5,    11,     4,     6,     9,    10,    11,     3,     7,
       5,    11,     0,    18,    22,    -1,    -1,    20
};
...
{
       0,     3,     5,    14,    15,    18,     4,    11,    19,    20,
       6,     9,    10,    11,    14,    16,    17,     0,     8,     4,
       7,     6,     7,    17,    19,    16
};
